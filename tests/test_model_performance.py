...
def _setup_mlflow():
    ...
    # Fix: correctly build tracking URI with repo URL
    tracking_uri = f"https://{mlflow_params['username']}:{token}@dagshub.com/{mlflow_params['username']}/{mlflow_params['repo']}.mlflow"
